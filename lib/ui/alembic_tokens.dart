...
class AlembicShadcnTokens {
  ...
  static const ColorScheme lightScheme = ColorScheme(
    ...
    background: m.Color(0xFFF4F4F4),
    foreground: m.Color(0xFF090909),
    card: m.Color(0xFFFFFFFF),
    cardForeground: m.Color(0xFF090909),
    popover: m.Color(0xFFFFFFFF),
    popoverForeground: m.Color(0xFF090909),
    ...
    muted: m.Color(0xFFEDEDED),
    mutedForeground: m.Color(0xFF707070),
    accent: m.Color(0xFFE6E6E6),
    accentForeground: m.Color(0xFF181818),
    destructive: m.Color(0xFF5C5C5C),
    border: m.Color(0xFFE2E2E2),
    input: m.Color(0xFFD7D7D7),
    ring: m.Color(0xFF9A9A9A),
    chart1: m.Color(0xFF181818),
    chart2: m.Color(0xFF3F3F3F),
    chart3: m.Color(0xFF707070),
    chart4: m.Color(0xFFA1A1A1),
    chart5: m.Color(0xFFD4D4D4),
    sidebar: m.Color(0xFFECECEC),
    sidebarForeground: m.Color(0xFF090909),
    sidebarPrimary: m.Color(0xFF181818),
    sidebarPrimaryForeground: m.Color(0xFFFAFAFA),
    sidebarAccent: m.Color(0xFFE6E6E6),
    sidebarAccentForeground: m.Color(0xFF181818),
    sidebarBorder: m.Color(0xFFE2E2E2),
    sidebarRing: m.Color(0xFF9A9A9A),
  );

  static const ColorScheme darkScheme = ColorScheme(
    brightness: Brightness.dark,
    background: m.Color(0xFF0B0B0B),
    foreground: m.Color(0xFFF4F4F4),
    card: m.Color(0xFF141414),
    cardForeground: m.Color(0xFFF4F4F4),
    popover: m.Color(0xFF171717),
    popoverForeground: m.Color(0xFFF4F4F4),
    primary: m.Color(0xFFF4F4F4),
    primaryForeground: m.Color(0xFF181818),
    secondary: m.Color(0xFF1D1D1D),
    secondaryForeground: m.Color(0xFFF4F4F4),
    muted: m.Color(0xFF1B1B1B),
    mutedForeground: m.Color(0xFFA1A1A1),
    accent: m.Color(0xFF272727),
    accentForeground: m.Color(0xFFF4F4F4),
    destructive: m.Color(0xFF9A9A9A),
    border: m.Color(0xFF2A2A2A),
    input: m.Color(0xFF2E2E2E),
    ...
    sidebar: m.Color(0xFF101010),
    sidebarForeground: m.Color(0xFFF4F4F4),
    sidebarPrimary: m.Color(0xFFF4F4F4),
    sidebarPrimaryForeground: m.Color(0xFF181818),
    sidebarAccent: m.Color(0xFF1D1D1D),
    sidebarAccentForeground: m.Color(0xFFF4F4F4),
    sidebarBorder: m.Color(0xFF2A2A2A),
